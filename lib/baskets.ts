...
const EU_CLEAR: Basket = {
  ...
  thesis:
    "Early cycle Europe means tilting to broad indices and cyclicals. Add a slug of mid-caps and EM for the rebound.",
  holdings: [
    holding("EXSA", "EXSA", 8031, "iShares STOXX Europe 600 UCITS ETF", 40,
      "Broad European equity",
      "STOXX 600 — the canonical Europe benchmark. 600 large- and mid-caps across 17 countries."),
    holding("DAXEX.DE", "DAXEX.DE", 3401, "iShares Core DAX UCITS ETF", 20,
      "German cyclicals",
      "DAX is heavy in autos, industrials and chemicals — the levered cyclical bet on a European expansion."),
    holding("IQQM.DE", "IQQM.DE", 10643, "iShares EURO STOXX Mid UCITS ETF", 20,
      "Eurozone mid-caps",
      "Mid-caps tend to outperform in the recovery leg of the cycle. Less crowded than large-caps."),
    holding("EIMI.L", "EIMI.L", 15435, "iShares Core MSCI EM IMI UCITS ETF", 20,
      "Emerging markets",
      "EM has historically led developed markets out of resets. Worthwhile sleeve in early-cycle EUR baskets."),
  ],
};
...
const EU_WATCH: Basket = {
  ...
  thesis:
    "Mid-cycle Europe rewards quality compounders and global dividend yields. Keep a STOXX 600 base, add a yield tilt and a global hedge.",
  holdings: [
    holding("EXSA", "EXSA", 8031, "iShares STOXX Europe 600 UCITS ETF", 35,
      "Broad European equity",
      "Core position — Europe-wide exposure across all sectors."),
    holding("VGWD.DE", "VGWD.DE", 10560, "Vanguard FTSE All-World High Dividend Yield UCITS ETF", 30,
      "Global high-dividend",
      "Highest-yielding stocks across developed + EM. Defensive bias by construction (financials + staples + energy)."),
    holding("VWCG.L", "VWCG.L", 13558, "Vanguard FTSE Developed Europe UCITS ETF", 20,
      "Developed Europe core",
      "Vanguard's developed-Europe exposure — overlaps STOXX 600 but with better ESG screening for those who want it."),
    holding("EUNA.DE", "EUNA.DE", 10586, "iShares Core Global Aggregate Bond UCITS ETF (EUR Hedged)", 15,
      "Bond ballast",
      "Global aggregate bonds, EUR-hedged — reduces equity volatility without taking duration risk."),
  ],
};
...
const EU_WARNING: Basket = {
  ...
  thesis:
    "Late cycle in Europe rotates to staples, healthcare and utilities. Add gold and inflation-linked govies for a real-asset hedge.",
  holdings: [
    holding("UTI.PA", "UTI.PA", 15320, "Amundi STOXX Europe 600 Utilities UCITS ETF Acc", 20,
      "European utilities",
      "Bond-proxy regulated utilities across Europe. Low beta, high dividend."),
    holding("FOO.PA", "FOO.PA", 15316, "Amundi STOXX Europe 600 Consumer Staples UCITS ETF Acc", 20,
      "Defensive consumer",
      "Nestle, L'Oreal, Unilever, AB InBev — defensive cash flows that hold up through downturns."),
    holding("SXDPEX.DE", "SXDPEX.DE", 10618, "iShares STOXX Europe 600 Health Care UCITS ETF", 15,
      "Healthcare",
      "Novo, Roche, Novartis, AstraZeneca — defensive growth, secular tailwinds."),
    holding("XY4P.DE", "XY4P.DE", 10614, "Xtrackers Eurozone Govt Bond Yield Plus UCITS ETF", 25,
      "Eurozone govt duration",
      "Higher-yielding eurozone government bonds — captures the rate-cut rally without taking peripheral risk."),
...
// =====================================================================
// EU — Storm: capital preservation (EUR)
// =====================================================================
const EU_STORM: Basket = {
  zone: "storm",
  region: "eu",
  title: "Capital preservation — EUR",
  thesis:
    "Reset mode in EUR: ultrashort euro bonds, gold and a small TIP-equivalent sleeve. Wait for valuations to reset before redeploying.",
  holdings: [
    holding("IS3M.DE", "IS3M.DE", 10565, "iShares EUR Ultrashort Bond UCITS ETF", 35,
      "EUR cash-equivalent",
      "EUR ultrashort bonds — the closest thing to BIL for euro investors."),
    ...
    holding("EUNA.DE", "EUNA.DE", 10586, "iShares Core Global Aggregate Bond UCITS ETF (EUR Hedged)", 25,
      "Diversified high-grade bonds",
      "Investment-grade global bonds, EUR-hedged. Captures duration rally without currency risk."),
    holding("IBCI.DE", "IBCI.DE", 10585, "iShares EUR Inflation Linked Govt Bond UCITS ETF", 15,
      "Inflation hedge",
      "Eurozone linkers — protects real purchasing power if the reset is inflationary."),
  ],
};
...
const UK_WATCH: Basket = {
  ...
  thesis:
    "Mid-cycle UK leans into the FTSE 100's yield character — already defensive vs the global mid-cycle. Add global high-dividend and a Gilt sleeve for ballast.",
  holdings: [
    holding("ISF.L", "ISF.L", 3052, "iShares Core FTSE 100 UCITS ETF (Dist)", 30,
      "Core UK yield",
      "FTSE 100 already yields ~3.9% — the natural UK mid-cycle position."),
    holding("VGWD.DE", "VGWD.DE", 10560, "Vanguard FTSE All-World High Dividend Yield UCITS ETF", 25,
      "Global high-dividend",
      "Best-of-breed global dividend exposure — diversifies the UK bet."),
    holding("VWRP.L", "VWRP.L", 14462, "Vanguard FTSE All-World UCITS ETF (USD Dis)", 25,
      "Broad global core",
      "Global beta — necessary because the FTSE alone is too narrow."),
    holding("SYBG.DE", "SYBG.DE", 10641, "SPDR Bloomberg UK Gilt UCITS ETF", 20,
      "Gilt ballast",
      "UK gilts smooth the equity ride. The only UK-gilt UCITS available on eToro."),
  ],
};
...
const UK_WARNING: Basket = {
  ...
  thesis:
    "Late cycle: UK staples + global defensive sectors + Gilt duration + gold. Tilt the basket toward survival-of-the-cycle, not capture-of-it.",
  holdings: [
    ...
    holding("FOO.PA", "FOO.PA", 15316, "Amundi STOXX Europe 600 Consumer Staples UCITS ETF Acc", 15,
      "Defensive consumer",
      "Pan-European staples — Unilever, Diageo, Reckitt also live here."),
    holding("SXDPEX.DE", "SXDPEX.DE", 10618, "iShares STOXX Europe 600 Health Care UCITS ETF", 15,
      "Healthcare",
      "Pan-European healthcare — overweight AstraZeneca, GSK alongside Roche/Novartis."),
...
const GLOBAL_CLEAR: Basket = {
  ...
  holdings: [
    holding("VWRP.L", "VWRP.L", 14462, "Vanguard FTSE All-World UCITS ETF (USD Dis)", 50,
      "Global core",
      "All-world — 4,000+ stocks across developed + EM. The cleanest single-trade global exposure."),
    holding("CNDX.L", "CNDX.L", 8015, "iShares NASDAQ 100 UCITS ETF", 20,
      "Growth tilt",
    ...
    holding("EXSA", "EXSA", 8031, "iShares STOXX Europe 600 UCITS ETF", 10,
      "Europe overweight",
      "All-world is ~60% US — adding Europe pushes the basket toward cheaper non-US developed markets."),
  ],
};
...
const GLOBAL_WATCH: Basket = {
  ...
  thesis:
    "Mid-cycle global means owning compounders and dividends, with a bond sleeve for ballast.",
  holdings: [
    holding("VWRP.L", "VWRP.L", 14462, "Vanguard FTSE All-World UCITS ETF (USD Dis)", 35,
      "Global core",
      "Keep a base in the broad global market."),
    holding("VGWD.DE", "VGWD.DE", 10560, "Vanguard FTSE All-World High Dividend Yield UCITS ETF", 30,
      "Global high-dividend",
      "Highest-yielding global stocks — defensive sector tilt by construction."),
    holding("DGRO", "DGRO", 3149, "iShares Core Dividend Growth ETF", 20,
      "US dividend growers",
...
const GLOBAL_STORM: Basket = {
  ...
  thesis:
    "Reset mode globally: short Treasuries, gold, ultrashort euro and sterling for currency diversification.",
  holdings: [
    holding("IB01.L", "IB01.L", 1442, "iShares $ Treasury Bond 0-1yr UCITS ETF", 30,
      "Short USD Treasuries",
      "0-1yr USD T-bills — the deepest cash-equivalent market in the world."),
    holding("IS3M.DE", "IS3M.DE", 10565, "iShares EUR Ultrashort Bond UCITS ETF", 20,
      "EUR ultrashort",
      "EUR cash-equivalent — diversifies USD-only exposure."),
    holding("ERNS.L", "ERNS.L", 14495, "iShares GBP Ultrashort Bond UCITS ETF", 15,
      "GBP ultrashort",
      "GBP cash-equivalent — sterling sleeve for currency diversification."),
    holding("IGLN.L", "IGLN.L", 15440, "iShares Physical Gold ETC", 25,
      "Currency-debasement hedge",
      "Physical gold — universal panic hedge."),
    holding("DTLA.L", "DTLA.L", 13564, "iShares USD Treasury Bond 20+yr UCITS ETF", 10,
      "Crisis duration",
