...
const UK_CLEAR: Basket = {
  ...
  holdings: [
    ...
    holding("ISAC.L", "ISAC.L", 15428, "iShares MSCI ACWI UCITS ETF", 25,
      "Global hedge",
      "MSCI ACWI — developed + emerging markets in one trade. Counterweights the UK domestic-economy bet with global growth."),
...
const UK_WATCH: Basket = {
  ...
  holdings: [
    ...
    holding("ISAC.L", "ISAC.L", 15428, "iShares MSCI ACWI UCITS ETF", 25,
      "Broad global core",
      "MSCI ACWI — global beta across developed + EM. Necessary because the FTSE alone is too narrow."),
    holding("AGGU.L", "AGGU.L", 13553, "iShares Core Global Aggregate Bond UCITS ETF (USD)", 15,
      "Global bond ballast",
...
const GLOBAL_CLEAR: Basket = {
  ...
  holdings: [
    holding("ISAC.L", "ISAC.L", 15428, "iShares MSCI ACWI UCITS ETF", 55,
      "Global core",
      "MSCI ACWI — 2,800+ stocks across developed + EM. The cleanest single-trade global exposure available as cash equity on eToro."),
...
const GLOBAL_WATCH: Basket = {
  ...
  holdings: [
    holding("ISAC.L", "ISAC.L", 15428, "iShares MSCI ACWI UCITS ETF", 40,
      "Global core",
      "MSCI ACWI — keep a base in the broad global market across developed + EM."),
    holding("DGRO", "DGRO", 3149, "iShares Core Dividend Growth ETF", 25,
      "US dividend growers",
